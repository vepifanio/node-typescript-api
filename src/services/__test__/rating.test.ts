...
describe('Rating service', () => {
  ...
  describe('Calculate rating for a given point', () => {
    ...
    it('Should get a rating of 3 for point with offshore winds and a half overhead height', () => {
      const point = {
        ...defaultPoint,
        ...{
          swellHeight: 0.7,
  ...
  describe('Get rating based on swell period', () => {
    ...
    it('should get rating of 5 for a period of 19 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(19);
      expect(rating).toBe(5);
    });
  });
